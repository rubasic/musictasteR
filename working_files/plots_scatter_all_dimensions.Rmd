...
plot_cross <- function(database,filtered_year,x_axis=energy,y_axis=danceability,track_name = track_name, artist_name = artist_name,title="Billboard Top 100 musical charts of "){
  ...
  tracklist <- database %>% filter(year == filtered_year | year == "0" ) %>%
    select(year,!!artist_name,!!track_name,!!x_axis,!!y_axis)
...
plot_cross(spotify_track_data,2010,energy,danceability,track_name,artist_name)
