...
hover_plot <- function(database,filtered_year,x_axis=energy,y_axis=danceability,track_name = track_name, artist_name = artist_name,title="Billboard Top 100 musical charts of "){
...
hover_plot(spotify_track_data,2010,energy,danceability,track_name,artist_name)
