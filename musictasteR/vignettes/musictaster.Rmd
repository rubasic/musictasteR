...
```{r eval=F}
#load the large data
df <- read.csv('/Users/miraekim/workspace/coursework/map535r/rubasic/working_files/150k_sample.csv')
df <- df[!is.na(df$key),]
...
probability_df <- get_probability_of_billboard(new_song2, log_model_list)
probability_df <- 
