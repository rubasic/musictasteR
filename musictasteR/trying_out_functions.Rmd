...
get_tracks_and_features <- function(track_artist_name, access_token = get_spotify_access_token()) {
...
nirvana <- get_tracks_and_features("nirvana", access_token = access_token)
```
