...
dim_pc_1 <- readRDS(model_hcpc_pca_clusters, file = "~/Documents/R Programming/Group Assignment/rubasic/rubasic/working_files/bb_princomp_lm_1.rda")
dim_pc_2 <- readRDS(model_hcpc_pca_clusters, file = "~/Documents/R Programming/Group Assignment/rubasic/rubasic/working_files/bb_princomp_lm_2.rda")
```
