...
map_df(seq_len(length(final_list)), function(x) {
                list(
                  track_name = final_list[[x]]["track_name"],
                  track_uri = final_list[[x]]["track_uri"],
                  album_name = final_list[[x]]["album_name"],
                  album_year = final_list[[x]]["album_year"],
                  album_year_4dgt = final_list[[x]]["album_year_4dgt"],
                  danceability = final_list[[x]]["danceability"],
                  energy = final_list[[x]]["energy"],
                  key = final_list[[x]]["key"],
                  loudness = final_list[[x]]["loudness"],
                  mode = final_list[[x]]["mode"],
                  speechiness = final_list[[x]]["speechiness"],
                  acousticness = final_list[[x]]["acousticness"],
                  instrumentalness = final_list[[x]]["instrumentalness"],
                  liveness = final_list[[x]]["liveness"],
                  valence = final_list[[x]]["valence"],
                  tempo = final_list[[x]]["tempo"],
                  type = final_list[[x]]["type"],
                  uri = final_list[[x]]["uri"],
                  track_href = final_list[[x]]["track_href"],
                  analysis_url = final_list[[x]]["analysis_url"],
                  duration_ms = final_list[[x]]["duration_ms"],
                  time_signature = final_list[[x]]["time_signature"],
                  artist_name = final_list[[x]]["artist_name"],
                  artist_id = final_list[[x]]["artist_uri"]
                )})
...
final_df <- map_df(seq_len(length(final_list[1:6000])), function(x) {
                list(
                  track_name = final_list[1:6000][[x]]["track_name"],
                  track_uri = final_list[1:6000][[x]]["track_uri"],
                  album_name = final_list[1:6000][[x]]["album_name"],
                  album_year = final_list[1:6000][[x]]["album_year"],
                  album_year_4dgt = final_list[1:6000][[x]]["album_year_4dgt"],
                  danceability = final_list[1:6000][[x]]["danceability"],
                  energy = final_list[1:6000][[x]]["energy"],
                  key = final_list[1:6000][[x]]["key"],
                  loudness = final_list[1:6000][[x]]["loudness"],
                  mode = final_list[1:6000][[x]]["mode"],
                  speechiness = final_list[1:6000][[x]]["speechiness"],
                  acousticness = final_list[1:6000][[x]]["acousticness"],
                  instrumentalness = final_list[1:6000][[x]]["instrumentalness"],
                  liveness = final_list[1:6000][[x]]["liveness"],
                  valence = final_list[1:6000][[x]]["valence"],
                  tempo = final_list[1:6000][[x]]["tempo"],
                  type = final_list[1:6000][[x]]["type"],
                  uri = final_list[1:6000][[x]]["uri"],
                  track_href = final_list[1:6000][[x]]["track_href"],
                  analysis_url = final_list[1:6000][[x]]["analysis_url"],
                  duration_ms = final_list[1:6000][[x]]["duration_ms"],
                  time_signature = final_list[1:6000][[x]]["time_signature"],
                  artist_name = final_list[1:6000][[x]]["artist_name"],
                  artist_id = final_list[1:6000][[x]]["artist_uri"]
                )})
```
